...
// .SECTION Description
// vtkOSPRayVolumeMapper is the abstract definition of a volume mapper for regular
...
#ifndef __vtkOSPRayVolumeMapper_h
#define __vtkOSPRayVolumeMapper_h
...
public:
  ...
  void SetBlendModeToComposite()
    { this->SetBlendMode( vtkOSPRayVolumeMapper::COMPOSITE_BLEND ); }
  void SetBlendModeToMaximumIntensity()
    { this->SetBlendMode( vtkOSPRayVolumeMapper::MAXIMUM_INTENSITY_BLEND ); }
  void SetBlendModeToMinimumIntensity()
    { this->SetBlendMode( vtkOSPRayVolumeMapper::MINIMUM_INTENSITY_BLEND ); }
  void SetBlendModeToAdditive()
    { this->SetBlendMode( vtkOSPRayVolumeMapper::ADDITIVE_BLEND ); }
