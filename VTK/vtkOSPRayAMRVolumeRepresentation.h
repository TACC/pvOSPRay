...
=========================================================================*/
// .NAME vtkOSPRayAMRVolumeRepresentation - representation used for volume
// rendering AMR datasets with ability to stream blocks.
// .SECTION Description
// vtkOSPRayAMRVolumeRepresentation  is a representation used for volume
// rendering AMR datasets with ability to stream blocks from the input pipeline.

#ifndef vtkOSPRayAMRVolumeRepresentation_h
#define vtkOSPRayAMRVolumeRepresentation_h
...
class VTKPVCLIENTSERVERCORERENDERING_EXPORT vtkOSPRayAMRVolumeRepresentation :
...
//BTX
protected:
  vtkOSPRayAMRVolumeRepresentation();
  ~vtkOSPRayAMRVolumeRepresentation();
...
private:
  vtkOSPRayAMRVolumeRepresentation(const vtkOSPRayAMRVolumeRepresentation&); // Not implemented
  void operator=(const vtkOSPRayAMRVolumeRepresentation&); // Not implemented
